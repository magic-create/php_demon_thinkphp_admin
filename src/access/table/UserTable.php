...
class UserTable extends DBTable
{
    ...
    {
        return UserModel::from((new UserModel())->getTable(), 'a')->where('a.status', '>=', 0)->leftJoin([AllotModel::field(DB::raw('GROUP_CONCAT(rid) as role,uid'))->group('uid')->buildSql() => 'b'], 'b.uid = a.uid');
    }
