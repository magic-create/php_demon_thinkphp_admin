...
class Publish extends Command
{
    ...
    protected function publishableChoices()
    {
        return array_merge(
            ...
            preg_filter('/^/', '<comment>Provider: </comment>', Arr::sort(app('admin.publish')->publishableProviders())),
            preg_filter('/^/', '<comment>Tag: </comment>', Arr::sort(app('admin.publish')->publishableGroups()))
        );
    }
    ...
    {
        return app('admin.publish')->pathsToPublish(
            $this->provider, $tag
        );
    }
