...
use Demon\AdminThinkPHP\support\Lang;
...
class Admin
{
    ...
    public function __construct(Config $config)
    {
        ...
        $this->log = new Log();
        $this->api = new Api();
        $this->view = app('admin.view');
        $this->multi = !is_dir(root_path('app' . DIRECTORY_SEPARATOR . 'controller'));
    }
     ...
     * @copyright 魔网天创信息科技
     */
    public function __($key, $replace = [], $locale = '')
    {
